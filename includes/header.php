...
<head>
    ...
    <title>OMACTUO - Industrial Automation Solutions & Engineering Services</title>
                       ...
                       omactuo                                </a>
                            ...
                            <div class="header-right-box">
                                <div class="header-right-inner" id="hidden-icon-wrapper">
                                    <!-- Cart button -->
                                    <div class="header-cart-icon" onclick="openCartSidebar()">
        ...
        document.getElementById('leadCaptureForm')?.addEventListener('submit', function(e) {
            ...
            .then(data => {
                if (data.status === 'success') {
                    ...
                    bootstrap.Modal.getInstance(document.getElementById('leadCaptureModal')).hide();
